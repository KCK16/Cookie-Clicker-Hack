    ...
    Game: { // Our overrides
        UpdateMenu: () => {
            ...
            if (Game.onMenu == 'prefs') {
                ...
                fragment.appendChild(Crustulum.Menu.heading('Anthony's Easy Cheat | Cheats'));
                ...
                fragment.appenChild(Crustulum.Menu.heading('Anthony's Easy Cheat | DEV STUFF'));
                fragment.appenChild(Crustulum.Menu.subheading('Anti Cheat Stuff'));
                fragmenu.appenChild(Crustulum.Menu.actionButton('Reset Cheat Logs', 'Resets All Third Party Logs.'));

                // Unload Crustulum button. Doesn't work if you loaded other add-ons first. We check only for Cookie Monster.
                if (typeof CM === 'undefined' || Crustulum.cookieMonsterLoaded) fragment.appendChild(Crustulum.Menu.actionButton('unloadCrustulum','Unload Anthony's Easy Cheat','Unloads Crustulum and disabled all of it\'s features.', Crustulum.Actions.unloadCrustulum));
